...
CREATE TABLE `article` (
  ...
  `typeId` int(11) DEFAULT NULL COMMENT '栏目Id,外键',
  PRIMARY KEY (`articleId`),
  KEY `a_fk_1` (`typeId`),
  CONSTRAINT `a_fk_1` FOREIGN KEY (`typeId`) REFERENCES `article_sort` (`typeId`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

/*Data for the table `article` */

insert  into `article`(`articleId`,`articleName`,`articleTime`,`articleContent`,`articleClick`,`articleSupport`,`articleUp`,`articleType`,`imgPath`,`typeId`) values (1,'住在手机里的朋友','2017-03-02','通信时代，无论是初次相见还是老友重逢，交换联系方式，常常是彼此交换名片，然后郑重或是出于礼貌用手机记下对方的电话号码。在快节奏的生活里，我们不知不觉中就成为住在别人手机里的朋友。又因某些意外，变成了别人手机里匆忙的过客，这种快餐式的友谊 ...',1,1,0,1,'static/images/02.jpg',1),(2,'教你怎样用欠费手机拨打电话','2017-01-01','初次相识的喜悦，让你觉得似乎找到了知音。于是，对于投缘的人，开始了较频繁的交往。渐渐地，初识的喜悦退尽，接下来就是仅仅保持着联系，平淡到偶尔在节假曰发短信互致问候...',2,1,0,1,'static/images/02.jpg',1),(3,'你面对的是生活而不是手机','2017-03-10','每一次与别人吃饭，总会有人会拿出手机。以为他们在打电话或者有紧急的短信，但用余光瞟了一眼之后发现无非就两件事：1、看小说，2、上人人或者QQ...',3,1,0,1,'static/images/02.jpg',1),(4,'你面对的是生活而不是手机','2017-04-01','每一次与别人吃饭，总会有人会拿出手机。以为他们在打电话或者有紧急的短信，但用余光瞟了一眼之后发现无非就两件事：1、看小说，2、上人人或者QQ...',4,1,0,1,'static/images/02.jpg',1),(5,'你面对的是生活而不是手机','2017-03-28','每一次与别人吃饭，总会有人会拿出手机。以为他们在打电话或者有紧急的短信，但用余光瞟了一眼之后发现无非就两件事：1、看小说，2、上人人或者QQ...',5,1,0,1,'static/images/02.jpg',1),(6,'测试','2017-03-29','每一次与别人吃饭，总会有人会拿出手机。以为他们在打电话或者有紧急的短信，但用余光瞟了一眼之后发现无非就两件事：1、看小说，2、上人人或者QQ...',6,1,0,1,'static/images/02.jpg',1),(7,'测试数据','2017-03-30','测试',7,1,0,1,'static/images/02.jpg',1),(8,'测试数据','2017-03-01','测试数据',8,1,0,1,'static/images/02.jpg',1);
...
CREATE TABLE `article_sort` (
  ...
  PRIMARY KEY (`typeId`,`name`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;

/*Data for the table `article_sort` */

insert  into `article_sort`(`typeId`,`name`) values (1,'个人博客'),(2,'算法分析'),(3,'WebService'),(4,'JVM'),(5,'JavaEE框架'),(6,'Html5'),(7,'JavaScript'),(8,'Android'),(9,'网络编程'),(10,'Lucene'),(11,'Shiro'),(12,'Jquery'),(13,'SpringMVC'),(14,'Struts2'),(15,'设计模式');
...
insert  into `friendly_link`(`linkId`,`linkName`,`linkUrl`) values (1,'Nicky\'s blog','https://u014427391.github.io/'),(2,'Android开发技术周报','http://androidweekly.cn/'),(3,'测试','http://androidweekly.cn/'),(4,'CSDN博客','https://u014427391.github.io/'),(5,'CSDN博客','https://u014427391.github.io/'),(6,'CSDN博客','https://blog.csdn.net');
...
insert  into `user`(`id`,`name`,`password`) values (1,'ara','123'),(2,'ara','123');
...
insert  into `web_ad`(`adId`,`adTitle`,`adImage`,`adDesc`) values (1,'测试1','static/blog/images/01.jpg','add your description here'),(2,'测试2','static/blog/images/02.jpg','add your description here'),(3,'测试3','static/blog/images/03.jpg','add your description here'),(4,'测试4','static/blog/images/02.jpg','add your description here'),(5,'测试5','static/blog/images/04.jpg','add your description here');
